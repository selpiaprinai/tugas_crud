...
$matkul = queryMatkul("SELECT * FROM makul");
...
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <a href="/TUGAS_PEMROGRAMAN"><i class="fa fa-home"></i> Home</a> /<b>MatKul</b>
                    ...
                    <table class="table table-striped table-responsiv">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?= $row["sks"];?></td>
                                <td class="gap-4">
                                    <a class="text-primary mr-3" href="edit.php?id=<?= $row["id_mk"]; ?>"><i class="fa fa-edit"></i></a>|
                                    <a onclick="return confirm('Apakah Yakin Ingin Hapus Data?')" class="text-danger ml-3" href="delete.php?id=<?= $row["id_mk"]; ?>"><i class="fa fa-trash"></i></a>
                                </td></tr>
                            <?php } ?>
                        </tbody>
                    </table>
